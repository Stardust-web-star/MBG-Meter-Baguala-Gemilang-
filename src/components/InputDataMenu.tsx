    ...
    <div className="space-y-4 max-w-5xl mx-auto">
      ...
      <div className="bg-white dark:bg-slate-900 px-5 py-3.5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-2xs flex flex-col md:flex-row md:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-2.5 py-1.5 bg-blue-50 hover:bg-blue-100 dark:bg-blue-950/60 dark:hover:bg-blue-900/60 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800 rounded-lg text-xs font-bold transition flex items-center gap-1 shadow-2xs cursor-pointer"
          >
          ...
          <button
            ...
            className="px-2.5 py-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 border border-slate-300 dark:border-slate-700 rounded-lg text-xs font-bold transition flex items-center gap-1 shadow-2xs cursor-pointer"
          >
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-2xs overflow-hidden">
        <div className="bg-slate-900 dark:bg-slate-950 px-4 py-3 text-white flex items-center justify-between border-b border-slate-800">
          ...
          <span className="text-[10px] bg-slate-800 dark:bg-slate-900 text-slate-300 font-mono font-bold px-2 py-0.5 rounded border border-slate-700">
            Kategori: {gantiMeter}
          </span>
        </div>
        ...
        <form onSubmit={handleFormSubmit} className="p-5 space-y-4 text-xs">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2 pb-1.5 border-b border-slate-100 dark:border-slate-800">
              <span className="w-5 h-5 rounded bg-blue-100 dark:bg-blue-950 text-blue-800 dark:text-blue-300 text-[11px] font-black flex items-center justify-center">
                1
              </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-2.5 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded font-mono font-bold text-slate-900 dark:text-slate-100 focus:bg-white dark:focus:bg-slate-900 focus:ring-1 focus:ring-blue-500 focus:outline-none"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-2.5 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded font-bold text-slate-900 dark:text-slate-100 focus:bg-white dark:focus:bg-slate-900 focus:ring-1 focus:ring-blue-500 focus:outline-none uppercase"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-2.5 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded font-bold text-slate-800 dark:text-slate-200 focus:bg-white dark:focus:bg-slate-900 focus:ring-1 focus:ring-blue-500 focus:outline-none"
                >
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-2.5 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded font-mono font-bold text-slate-800 dark:text-slate-200 focus:bg-white dark:focus:bg-slate-900 focus:ring-1 focus:ring-blue-500 focus:outline-none"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-2.5 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded font-mono text-slate-800 dark:text-slate-200 focus:bg-white dark:focus:bg-slate-900 focus:ring-1 focus:ring-blue-500 focus:outline-none"
                />
              </div>
              ...
              <div className="md:col-span-3">
                ...
                <input
                  ...
                  className="w-full px-2.5 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded text-slate-800 dark:text-slate-200 focus:bg-white dark:focus:bg-slate-900 focus:ring-1 focus:ring-blue-500 focus:outline-none"
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-2.5 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded font-mono font-bold text-blue-900 dark:text-blue-300 focus:bg-white dark:focus:bg-slate-900 focus:ring-1 focus:ring-blue-500 focus:outline-none"
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-2.5 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded font-mono text-slate-900 dark:text-slate-100 focus:bg-white dark:focus:bg-slate-900 focus:ring-1 focus:ring-blue-500 focus:outline-none"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-2.5 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded font-medium text-slate-800 dark:text-slate-200 focus:bg-white dark:focus:bg-slate-900 focus:ring-1 focus:ring-blue-500 focus:outline-none"
                >
          ...
          <div className="space-y-3 pt-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <div className="p-2.5 bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-lg">
                <label className="text-[10px] font-bold text-slate-600 dark:text-slate-400 mb-1 uppercase block">
                ...
                <select
                  ...
                  className="w-full p-1.5 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded font-bold text-slate-900 dark:text-slate-100 focus:ring-1 focus:ring-blue-500 focus:outline-none"
                >
          ...
          <div className="pt-3 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <button
                ...
                className="px-3.5 py-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-bold text-xs rounded-lg flex items-center justify-center gap-1.5 transition cursor-pointer"
              >
      ...
      {showConfirmModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/75 backdrop-blur-md p-4">
          <div className="bg-white dark:bg-slate-900 rounded-xl p-5 max-w-md w-full shadow-2xl border border-slate-200 dark:border-slate-800 space-y-3 animate-fadeIn">
            <div className="w-10 h-10 rounded-lg bg-blue-100 dark:bg-blue-950 text-blue-700 dark:text-blue-300 flex items-center justify-center mx-auto">
            ...
            <div className="p-2.5 bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-lg text-xs space-y-1 font-mono">
              <div className="flex justify-between">
                <span className="text-slate-500 dark:text-slate-400 font-sans">Petugas:</span>
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-emerald-700 dark:text-emerald-400">{status}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-500 dark:text-slate-400 font-sans">Jenis / Alasan:</span>
                <span className="font-bold text-slate-800 dark:text-slate-200">{jenis} / {gantiMeter}</span>
              </div>
            </div>
            ...
            <div className="flex gap-2 pt-2">
              <button
                ...
                className="flex-1 py-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-bold text-xs rounded-lg cursor-pointer"
              >
                Batal
              </button>
              <button
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/75 backdrop-blur-md p-4">
          <div className="bg-white dark:bg-slate-900 rounded-xl p-5 max-w-sm w-full shadow-2xl border border-slate-200 dark:border-slate-800 space-y-3 animate-fadeIn text-center">
            ...
            <div className="p-2.5 bg-slate-50 dark:bg-slate-800/80 rounded-lg border border-slate-200 dark:border-slate-700 text-xs text-left">
              <div className="font-bold text-slate-800 dark:text-slate-200">{lastInsertedRecord?.namaPelanggan}</div>
              <div className="text-slate-500 dark:text-slate-400 font-mono text-[11px]">IDPEL: {lastInsertedRecord?.idPelanggan}</div>
            ...
            <div className="flex gap-2 pt-2">
              <button
                ...
                className="flex-1 py-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 font-bold text-xs rounded-lg cursor-pointer"
              >
                + Input Lagi
              </button>
              <button
